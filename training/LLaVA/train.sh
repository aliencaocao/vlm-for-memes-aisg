export WANDB_NAME='llava-1.6-mistral-7b-r128-a256-lr1e4-with-sg-no-eval-sampling-lora'
...
--version v1 \
--data_path ../training/train_with_sg_dedup.json \
